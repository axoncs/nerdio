...
##### Required Variables #####
	...
	$geoLocationUrl = $SecureVars.geoLocationUrl
	$datacenter = $SecureVars.datacenter
	$Sig = $SecureVars.sig
	$Sha256Sig = $SecureVars.sha256sig
...
&$onboardingScript $OrgID $geoLocationUrl $datacenter $Sig $Sha256Sig
